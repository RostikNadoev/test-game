...
export const RaceGame: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      // Body
      ctx.fillStyle = 'rgba(0,0,0,0.3)'; ctx.fillRect(-18, -10, 38, 22); // Shadow
      ctx.fillStyle = '#f1c40f'; ctx.fillRect(-20, -11, 40, 22); // Main
      ctx.fillStyle = '#d35400'; ctx.fillRect(-5, -11, 15, 3); ctx.fillRect(-5, 8, 15, 3); // Decals
